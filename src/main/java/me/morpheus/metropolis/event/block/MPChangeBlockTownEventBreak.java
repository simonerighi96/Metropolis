...
public final class MPChangeBlockTownEventBreak implements ChangeBlockTownEvent.Break {

    private final Cause cause;
    private final List<Transaction<BlockSnapshot>> transactions;
    private boolean cancelled = false;

    public MPChangeBlockTownEventBreak(Cause cause, List<Transaction<BlockSnapshot>> transactions) {
        this.cause = cause;
