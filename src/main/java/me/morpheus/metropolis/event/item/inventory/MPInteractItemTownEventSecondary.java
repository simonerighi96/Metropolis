...
public final class MPInteractItemTownEventSecondary implements InteractItemTownEvent.Secondary {
    ...
    public MPInteractItemTownEventSecondary(Cause cause, @Nullable Vector3d hit, ItemStackSnapshot itemStack) {
        this.cause = cause;
        this.hit = hit;
